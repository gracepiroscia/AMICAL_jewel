...
def get_mask(ins, mask, first=0):
    ...
    dic_mask = {
        ...
        "VAMPIRES": {
            ...
            "g7":1e3*np.array( # Mask coords in pupil plane (mm)
                    [
                    [-0.00122182, -0.00238327],
                    [ 0.00169345, -0.00253605],
                    [ 0.00103079, -0.00123551],
                    [ 0.00248842, -0.00131189],
                    [-0.00254714,  0.00021782],
                    [ 0.00262074, 0.00121281],
                    [ 0.00050045, 0.00258975],
                    ]
            ),
            # pupil plane (m)
            'jewel_4x5_0': 1e-3*np.array([[ 1.60104129, -2.16266909],
                        [-0.04160433,  2.92506604],
                        [-2.83682882,  0.81871363],
                        [-1.62072561, -0.79510995],
                        [ 2.39060191, -0.30258109],
                    ]
            ),
            'jewel_4x5_1': 1e-3*np.array([[ 0.66929986, -2.86478642],
                        [ 1.45886047, -1.00469869],
                        [ 1.03231787,  2.46921298],
                        [-2.55246717, -1.49722758],
                        [-0.97334583,  2.22294847],
                    ]
            ),
            'jewel_4x5_2': 1e-3*np.array([[ 0.10057649,  1.76709564],
                        [ 2.24842108,  0.85538946],
                        [-1.76290644,  0.36286056],
                        [-0.40462243, -2.40893359],
                        [ 2.53278273, -1.46055152],
            ]
            ),
            'jewel_4x5_3': 1e-3*np.array([[ 2.10624025,  2.01335992 ],
                        [ -1.90508738,  1.52083114],
                        [0.52711903, -1.70681591],
                        [-1.47854479, -1.95308041 ],
                        [-2.69464799, -0.33925695 ],
                    ]
            ),
        },
    }
