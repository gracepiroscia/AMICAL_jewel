...
def get_mask(ins, mask, first=0):
    ...
    dic_mask = {
        ...
        "VAMPIRES": {
            ...
            'jewel_4x5_0': np.array([[ 1.60104129, -2.16266909],
            ...
            'jewel_4x5_1': np.array([[ 0.66929986, -2.86478642],
            ...
            'jewel_4x5_2': np.array([[ 0.10057649,  1.76709564],
            ...
            'jewel_4x5_3': np.array([[ 2.10624025,  2.01335992 ],
